...
class Calculator:
    ...
    def create_widgets(self):
        ...
        buttons = [
            {"text": "C", "command": self.clear, "bg": "#fe9037"},
            {"text": "/", "command": lambda: self.show("/"), "bg": "#fe9037"},
            {"text": "%", "command": lambda: self.show("%"), "bg": "#fe9037"},
            {"text": "*", "command": lambda: self.show("*"), "bg": "#fe9037"},
            {"text": "7", "command": lambda: self.show("7"), "bg": "#2a2d36"},
            ...
            {"text": "4", "command": lambda: self.show("4"), "bg": "#2a2d36"},
            {"text": "5", "command": lambda: self.show("5"), "bg": "#2a2d36"},
            {"text": "6", "command": lambda: self.show("6"), "bg": "#2a2d36"},
            {"text": "+", "command": lambda: self.show("+"), "bg": "#2a2d36"},
            {"text": "1", "command": lambda: self.show("1"), "bg": "#2a2d36"},
